  ...
  return (
    <div className="mx-auto max-w-sm px-6 py-16">
      ...
      >
        ...
        <button data-testid="auth-submit" className="inline-flex items-center rounded-md bg-foreground px-4 py-2 text-sm font-medium text-background hover:opacity-90" type="submit">Sign in</button>
      </form>
    </div>
  )
}
